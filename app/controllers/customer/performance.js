...
exports.monthly_sales = function (req, res) {
    ...
    data.type = "sales";
    data.tipType = "Month";
    data.sideDropDown = "both"
    data.filterUrl = "sales-filter/monthly"
    data.day_url = 'performance';
    data.week_url = 'performance/weekly-sales';
    data.month_url = 'performance/monthly-sales';
    data.year_url = 'performance/yearly-sales';
    data.top_filter_sale = 'performance';
    data.top_filter_tip = 'performance/tips';
    data.top_filter_customer = 'performance/customer-satisfaction';
    data.top_filter_visit = 'performance/visit-overview';
        ...
        function (callback) {
            ...
            }, { "$sort": { "created_date": 1 } },
            {
                ...
                result.forEach(element => {
                   ...
                   // console.log("month_data_list -- " , month_data_list);
...
exports.yearly_sales = function (req, res) {
    ...
    data.type = "sales"
    data.sideDropDown = "both"
    data.filterUrl = "sales-filter/yearly"
    data.day_url = 'performance';
    data.week_url = 'performance/weekly-sales';
    data.month_url = 'performance/monthly-sales';
    data.year_url = 'performance/yearly-sales';
...
exports.day_sales = async function (req, res) {
    ...
    data.tipType = "Day";
    data.sideDropDown = "both"
    data.filterUrl = "sales-filter/daily"
    data.day_url = 'performance';
    data.week_url = 'performance/weekly-sales';
    data.month_url = 'performance/monthly-sales';
    data.year_url = 'performance/yearly-sales';
        ...
        function (callback) {
            appointments.find({
                ...
                if (err) {
                    ...
                    //console.log("user days reports...", userReports);
                    result.forEach(function (user, key, value) {
...
exports.weekly_sales = function (req, res) {
    ...
    data.type = "sales";
    data.sideDropDown = "both"
    data.filterUrl = "sales-filter/weekly" 
    data.day_url = 'performance';
    data.week_url = 'performance/weekly-sales';
    data.month_url = 'performance/monthly-sales';
    data.year_url = 'performance/yearly-sales';
            ...
            appointments.aggregate(
                ...
                if (err) {
                   ...
                   // console.log("result-- jhjhg --jhvjh--- inside", result);
                    if (result.length > 0) {
                        result.forEach(ele => {
                            var weeknumberDb = moment(ele._id.week, "MMDDYYYY").isoWeek();
                            var weeknumber = moment(userReports[0].key, "MMDDYYYY").isoWeek();
...
exports.day_tips = function (req, res) {
    ...
    data.type = "tips"
    data.tipType = "Day"
    data.filterUrl = "tips-filter/daily";
    data.day_url = 'performance/tips';
    data.week_url = 'performance/weekly-tips';
    data.month_url = 'performance/monthly-tips';
    data.year_url = 'performance/yearly-tips';
    data.top_filter_sale = 'performance';
    data.top_filter_tip = 'performance/tips';
    data.top_filter_customer = 'performance/customer-satisfaction';
    data.top_filter_visit = 'performance/visit-overview';
...
exports.weekly_tips = function (req, res) {
    ...
    data.type = "tips"
    data.tipType = "Week"
    data.filterUrl = "tips-filter/weekly";
    //data.filterUrl = "tips-filter/daily";
    data.day_url = 'performance/tips';
    data.week_url = 'performance/weekly-tips';
    data.month_url = 'performance/monthly-tips';
...
exports.monthly_tips = function (req, res) {
    ...
    data.type = "tips"
    data.tipType = "Month"
    data.filterUrl = "tips-filter/monthly";
    //data.filterUrl = "tips-filter/daily";
    data.day_url = 'performance/tips';
    data.week_url = 'performance/weekly-tips';
    data.month_url = 'performance/monthly-tips';
                ...
                result.forEach(element => {
                    ...
                    function getUniqueDataCount(objArr, propName) {
                        ...
                        for (var i = 0; i < uniqueList.length; i++) {
                            ...
                            var amountCount = 0.0;
                            for (var j = 0; j < objArr.length; j++) {
                                if (uniqueList[i] == moment(objArr[j].created_date).format("MMM")) {
                                    console.log("-----counts-----");
                                    countt += 1;
                                    if (objArr[j].tip !== undefined) {
                                        amountCount += parseFloat(objArr[j].tip)
                ...
                if (err) {
                  ...
                  //  salesReports.reverse();
                    result.forEach(function (user, key, value) {
                     ...
                     console.log("salesReports omnths----------", salesReports);
                   // salesReports.reverse();
                    data.salesReports = salesReports;
                    callback();
                }
...
exports.yearly_tips = function (req, res) {
    ...
    data.type = "tips"
    data.tipType = "Year"
    data.filterUrl = "tips-filter/yearly";
    //data.filterUrl = "tips-filter/daily";
    data.day_url = 'performance/tips';
    data.week_url = 'performance/weekly-tips';
    data.month_url = 'performance/monthly-tips';
...
exports.day_customer_satisfaction = function (req, res) {
    ...
    data.session = req.session;
    data.dateFormat = dateFormat;
    data.filterUrl = "customer-satisfaction-filter/daily"
    ...
    data.top_filter_visit = 'performance/visit-overview';
    data.sideDropDown = "both";
    data.day_url = 'performance/customer-satisfaction';
    data.week_url = 'performance/customer-satisfaction/weekly';
    data.month_url = 'performance/customer-satisfaction/monthly';
    data.year_url = 'performance/customer-satisfaction/yearly';
    data.from = req.body.from ? req.body.from : '';
    data.to = req.body.to ? req.body.to : '';
            ...
            appointments.find({
                ...
                if (err) {
                    ...
                    result.forEach(function (user, key, value) {
                        ...
                        console.log(monthName ,'----' ,amount);
                        userReports.map(index => index.key == monthName ? index.value1 += amount : index.value);
                        userReports.map(index => index.key == monthName ? index.value2 += 1 : index.value);
                    });
                 //   userReports.reverse();
                    data.salesReports = userReports;
                    console.log("dates data -->", userReports);
                    callback();
                }
            })
        }
...
exports.weekly_customer_satisfaction = function (req, res) {
    ...
    data.session = req.session;
    data.dateFormat = dateFormat;
    data.filterUrl = "customer-satisfaction-filter/weekly"
    data.type = "customer_satisfaction"
    data.tipType = "Week"
    data.top_filter_sale = 'performance';
    data.top_filter_tip = 'performance/tips';
...
exports.monthly_customer_satisfaction = function (req, res) {
    ...
    data.session = req.session;
    data.dateFormat = dateFormat;
    data.filterUrl = "customer-satisfaction-filter/monthly"
    data.type = "customer_satisfaction"
    data.tipType = "Month"
    data.top_filter_sale = 'performance';
    data.top_filter_tip = 'performance/tips';
...
exports.yearly_customer_satisfaction = function (req, res) {
    ...
    data.session = req.session;
    data.dateFormat = dateFormat;
    data.filterUrl = "customer-satisfaction-filter/yearly"
    data.type = "customer_satisfaction"
    data.tipType = "Year"
    data.top_filter_sale = 'performance';
    data.top_filter_tip = 'performance/tips';
...
exports.day_visit_overview = function (req, res) {
    ...
    data.type = "visit"
    data.tipType = "Day"
    data.filterUrl = "visit-filter/daily"
    data.top_filter_sale = 'performance';
    data.top_filter_tip = 'performance/tips';
    data.top_filter_customer = 'performance/customer-satisfaction';
    data.top_filter_visit = 'performance/visit-overview';
    data.sideDropDown = "both";
    data.day_url = 'performance/visit-overview';
    data.week_url = 'performance/visit-overview/weekly';
    data.month_url = 'performance/visit-overview/monthly';
    data.year_url = 'performance/visit-overview/yearly';
    data.from = req.body.from ? req.body.from : '';
    data.to = req.body.to ? req.body.to : '';
...
exports.weekly_visit_overview = function (req, res) {
    ...
    data.type = "visit";
    data.tipType = "Week";
    data.filterUrl = "visit-filter/weekly";
    data.top_filter_sale = 'performance';
    data.top_filter_tip = 'performance/tips';
    data.top_filter_customer = 'performance/customer-satisfaction';
    data.top_filter_visit = 'performance/visit-overview';
...
exports.monthly_visit_overview = function (req, res) {
    ...
    data.type = "visit"
    data.tipType = "Month"
    data.filterUrl = "visit-filter/monthly"
    data.top_filter_sale = 'performance';
    data.top_filter_tip = 'performance/tips';
    data.top_filter_customer = 'performance/customer-satisfaction';
    data.top_filter_visit = 'performance/visit-overview';
...
exports.yearly_visit_overview = function (req, res) {
    ...
    data.type = "visit"
    data.tipType = "Year"
    data.filterUrl = "visit-filter/yearly"
    data.top_filter_sale = 'performance';
    data.top_filter_tip = 'performance/tips';
    data.top_filter_customer = 'performance/customer-satisfaction';
    data.top_filter_visit = 'performance/visit-overview';
...
exports.sales_yearly_filter = function (req, res) {
    ...
    var startDate = new Date(req.body.from);
    var endDate = new Date(req.body.to);
    endDate = moment(endDate, "yyyy-MM-DD").add('days', 1);
    ...
    var tasks = [
        function (callback) {
            ...
            }, { "$sort": { "created_date": 1 } },
            {
                ...
                month_data_list.sort( function ( a, b ) {
                    return moment(a.title, 'MMMM-YYYY').format('MM') - moment(b.title, 'MMMM-YYYY').format('MM');
                    } );
                data.result = month_data_list;
                callback();
            })
...
exports.customer_satisfaction_yearly_filter = function (req, res) {
    ...
    data.month_url = 'performance/customer-satisfaction/monthly';
    data.year_url = 'performance/customer-satisfaction/yearly';
    console.log("customer satifaction yearly-filter --->",req.body);
    var startDate = new Date(req.body.from);
    var endDate = new Date(req.body.to);
    endDate.setDate(endDate.getDate() + 1);
