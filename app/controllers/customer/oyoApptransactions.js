...
exports.monthly_sales = function (req, res) {
    ...
    data.type = "sales";
    data.tipType = "Month";
    data.sideDropDown = "non-oyo";
    data.filterUrl = "oyo/sales-filter/monthly"
    data.day_url = 'oyo/performance';
    data.week_url = 'oyo/performance/weekly-sales';
    data.month_url = 'oyo/performance/monthly-sales';
    data.year_url = 'oyo/performance/yearly-sales';
    data.top_filter_sale = 'oyo/performance';
    data.top_filter_tip = 'oyo/performance/tips';
    data.top_filter_customer = 'oyo/performance/customer-satisfaction';
    data.top_filter_visit = 'oyo/performance/visit-overview';
    var tasks = [
        function (callback) {
            appointments.aggregate([{
                $match: {
                    ispEmail: req.app.locals.userCustomerSession.mail, walk_in: true,
                    amount: { $gt: 0 },
                    status: { $ne: "Cancelled" },
                    created_date: {
...
exports.yearly_sales = function (req, res) {
    ...
    data.dateFormat = dateFormat;
    data.type = "sales"
    data.filterUrl = "oyo/sales-filter/yearly"
    data.day_url = 'oyo/performance';
    data.week_url = 'oyo/performance/weekly-sales';
    data.month_url = 'oyo/performance/monthly-sales';
    data.year_url = 'oyo/performance/yearly-sales';
...
exports.day_sales = async function (req, res) {
    ...
    data.tipType = "Day";
    data.sideDropDown = "non-oyo"
    data.filterUrl = "oyo/sales-filter/daily";
    data.day_url = 'oyo/performance';
    data.week_url = 'oyo/performance/weekly-sales';
    data.month_url = 'oyo/performance/monthly-sales';
    data.year_url = 'oyo/performance/yearly-sales';
...
exports.weekly_sales = function (req, res) {
    ...
    data.tipType = "Week";
    data.sideDropDown = "non-oyo"
    data.filterUrl = "oyo/sales-filter/weekly";
    data.day_url = 'oyo/performance';
    data.week_url = 'oyo/performance/weekly-sales';
    data.month_url = 'oyo/performance/monthly-sales';
    data.year_url = 'oyo/performance/yearly-sales';
                ...
                if (err) {
                    ...
                    if (result.length > 0) {
                        result.forEach(ele => {
                            ...
                            console.log("db date --", ele._id.week, "user re---", userReports[0].key);
                        })
...
exports.day_tips = function (req, res) {
    ...
    data.type = "tips"
    data.tipType = "Day";
    data.filterUrl = "oyo/tips-filter/daily";
    data.sideDropDown = "non-oyo";
    data.day_url = 'oyo/performance/tips';
    data.week_url = 'oyo/performance/weekly-tips';
    data.month_url = 'oyo/performance/monthly-tips';
    data.year_url = 'oyo/performance/yearly-tips';
    data.top_filter_sale = 'oyo/performance';
    data.top_filter_tip = 'oyo/performance/tips';
    data.top_filter_customer = 'oyo/performance/customer-satisfaction';
    data.top_filter_visit = 'oyo/performance/visit-overview';
...
exports.weekly_tips = function (req, res) {
    ...
    data.type = "tips"
    data.tipType = "Week"
    data.filterUrl = "oyo/tips-filter/weekly";
    data.sideDropDown = "non-oyo";
    data.day_url = 'oyo/performance/tips';
    data.week_url = 'oyo/performance/weekly-tips';
    data.month_url = 'oyo/performance/monthly-tips';
...
exports.monthly_tips = function (req, res) {
    ...
    data.type = "tips"
    data.tipType = "Month"
    data.filterUrl = "oyo/tips-filter/monthly"
    data.sideDropDown = "non-oyo";
    data.day_url = 'oyo/performance/tips';
    data.week_url = 'oyo/performance/weekly-tips';
    data.month_url = 'oyo/performance/monthly-tips';
...
exports.yearly_tips = function (req, res) {
    ...
    data.type = "tips"
    data.tipType = "Year"
    data.filterUrl = "oyo/tips-filter/yearly";
    data.sideDropDown = "non-oyo";
    data.day_url = 'oyo/performance/tips';
    data.week_url = 'oyo/performance/weekly-tips';
    data.month_url = 'oyo/performance/monthly-tips';
...
exports.day_customer_satisfaction = function (req, res) {
    ...
    data.session = req.session;
    data.dateFormat = dateFormat;
    data.filterUrl = "oyo/customer-satisfaction-filter/daily"
    data.type = "customer_satisfaction"
    data.tipType = "Day"
    data.sideDropDown = "non-oyo";
    data.day_url = 'oyo/performance/customer-satisfaction';
    data.week_url = 'oyo/performance/customer-satisfaction/weekly';
    data.month_url = 'oyo/performance/customer-satisfaction/monthly';
    data.year_url = 'oyo/performance/customer-satisfaction/yearly';
    data.top_filter_sale = 'oyo/performance';
    data.top_filter_tip = 'oyo/performance/tips';
    data.top_filter_customer = 'oyo/performance/customer-satisfaction';
    data.top_filter_visit = 'oyo/performance/visit-overview';
        ...
        function (callback) {
            appointments.find({
                ...
                if (err) {
                    ...
                    result.forEach(function (user, key, value) {
                        let monthName = moment(user.rated_date).format("DD-MMM");
                        let amount = 0;
...
exports.weekly_customer_satisfaction = function (req, res) {
    ...
    data.session = req.session;
    data.dateFormat = dateFormat;
    data.filterUrl = "oyo/customer-satisfaction-filter/weekly"
    data.type = "customer_satisfaction"
    data.tipType = "Week"
    data.sideDropDown = "non-oyo";
    data.day_url = 'oyo/performance/customer-satisfaction';
...
exports.monthly_customer_satisfaction = function (req, res) {
    ...
    data.success = req.flash("success");
    data.session = req.session;
    data.filterUrl = "oyo/customer-satisfaction-filter/monthly"
    data.type = "customer_satisfaction"
    data.tipType = "Month"
    data.sideDropDown = "non-oyo";
    data.day_url = 'oyo/performance/customer-satisfaction';
...
exports.yearly_customer_satisfaction = function (req, res) {
    ...
    data.success = req.flash("success");
    data.session = req.session;
    data.filterUrl = "oyo/customer-satisfaction-filter/yearly"
    data.type = "customer_satisfaction"
    data.tipType = "Year"
    data.sideDropDown = "non-oyo";
    data.day_url = 'oyo/performance/customer-satisfaction';
...
exports.day_visit_overview = function (req, res) {
    ...
    data.type = "visit"
    data.tipType = "Day"
    data.filterUrl = "oyo/visit-filter/daily"
    data.top_filter_sale = 'oyo/performance';
    data.top_filter_tip = 'oyo/performance/tips';
    data.top_filter_customer = 'oyo/performance/customer-satisfaction';
    data.top_filter_visit = 'oyo/performance/visit-overview';
    data.sideDropDown = "non-oyo";
    data.day_url = 'oyo/performance/visit-overview';
    data.week_url = 'oyo/performance/visit-overview/weekly';
    data.month_url = 'oyo/performance/visit-overview/monthly';
    data.year_url = 'oyo/performance/visit-overview/yearly';
...
exports.weekly_visit_overview = function (req, res) {
    ...
    data.type = "visit";
    data.tipType = "Week";
    data.filterUrl = "oyo/visit-filter/weekly";
    data.top_filter_sale = 'oyo/performance';
    data.top_filter_tip = 'oyo/performance/tips';
    data.top_filter_customer = 'oyo/performance/customer-satisfaction';
    data.top_filter_visit = 'oyo/performance/visit-overview';
...
exports.monthly_visit_overview = function (req, res) {
    ...
    data.type = "visit"
    data.tipType = "Month"
    data.filterUrl = "oyo/visit-filter/monthly"
    data.top_filter_sale = 'oyo/performance';
    data.top_filter_tip = 'oyo/performance/tips';
    data.top_filter_customer = 'oyo/performance/customer-satisfaction';
    data.top_filter_visit = 'oyo/performance/visit-overview';
...
exports.yearly_visit_overview = function (req, res) {
    ...
    data.type = "visit"
    data.tipType = "Year"
    data.filterUrl = "oyo/visit-filter/yearly"
    data.top_filter_sale = 'oyo/performance';
    data.top_filter_tip = 'oyo/performance/tips';
    data.top_filter_customer = 'oyo/performance/customer-satisfaction';
    data.top_filter_visit = 'oyo/performance/visit-overview';
