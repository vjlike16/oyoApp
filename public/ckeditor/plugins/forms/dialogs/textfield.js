                ...
                children: [{
					...
					validate: function() {
						if(this.getValue() == 0 || this.getValue() == ""){
							return (alert("Name field is required."), !1)
						}else if(/^[a-zA-Z0-9-_]*$/.test(this.getValue()) == false){
							return (alert("Not allow SPACE, SPECIAL CHARACTER, NUMBERS into Name input."), !1)
						}
					},
                    "default": '',
                    accessKey: "N",
					...
					validate: function() {
						if(this.getValue() == 0 || this.getValue() == ""){
							return (alert("Value field is required."), !1)
						}
					},
                    "default": "",
                    accessKey: "V",
